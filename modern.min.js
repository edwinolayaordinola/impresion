...
if (!Array.prototype.firstOrDefault) {
    ...
    Object.defineProperty(Array.prototype, "firstOrDefault", { enumerable: false });
}
...
if (typeof Array.prototype.toObject !== 'function') {
    Array.prototype.toObject = function () {
        return Object.from(this);
    };
    Object.defineProperty(Array.prototype, "toObject", { enumerable: false });
}
if (!Array.prototype.keysList) {
    Array.prototype.keysList = (function () {
        'use strict';
        return function () {
            if (this === null || !Array.isArray(this)) {
                throw new TypeError('Array.keys called on non-array');
            }
            var result = [];
    ...
    Object.defineProperty(Array.prototype, "keysList", { enumerable: false });
}
if (!Array.prototype.valuesList) {
    Array.prototype.valuesList = (function () {
        'use strict';
        return function () {
            if (this === null || !Array.isArray(this)) {
                throw new TypeError('Array.values called on non-array');
            }
    ...
    Object.defineProperty(Array.prototype, "valuesList", { enumerable: false });
}
...
if (typeof Array.prototype.min !== "function") {
    Array.prototype.min = function (callback) {
        if (typeof callback === "function")
            return Math.min.apply(null, this.map(callback));
        else
...
if (typeof Array.prototype.sum !== "function") {
    Array.prototype.sum = function (callback) {
        if (typeof callback === "function")
            return this.map(callback).reduce(function (a, b) { return a + b; }, 0);
        else
...
if (typeof Array.prototype.count !== "function") {
    Array.prototype.count = function (callback) {
        if (typeof callback === "function")
            return this.map(callback).length;
        else
            return this.length;
    };
...
if (!Array.prototype.toUpperCase) {
    Array.prototype.toUpperCase = function (keyUpperCase) {
        return this.map(function (e) {
            var ee = e;
            if (typeof ee === "string")
                ee = ee.toUpperCase();
            else if (ee instanceof Object) {
                ee = {};
                var key = Object.keys(e)[0];
                var value = e[key];
                key = keyUpperCase === true ? key.toUpperCase() : key;
                ee[key] = value.toUpperCase();
            }
            return ee;
        });
    };
    Object.defineProperty(Array.prototype, "toUpperCase", { enumerable: false });
}
if (!Array.prototype.toLowerCase) {
    Array.prototype.toLowerCase = function (keyLowerCase) {
        return this.map(function (e) {
            var ee = e;
            if (typeof ee === "string")
                ee = ee.toLowerCase();
                ...
                var key = Object.keys(e)[0];
                var value = e[key];
                key = keyLowerCase === true ? key.toLowerCase() : key;
                ee[key] = value.toLowerCase();
            }
            return ee;
        });
    };
    Object.defineProperty(Array.prototype, "toLowerCase", { enumerable: false });
}
if (!Array.prototype.distinct) {
    Array.prototype.distinct = function (callback) {
        var callbackFilter = function (value, self) {
            return callback === undefined ? self.indexOf(value) : self.findIndex(function (t) { return callback(t) === callback(value); });
        };
        return this.filter(function (value, index, self) {
            return callbackFilter(value, self) === index;
        });
    };
    Object.defineProperty(Array.prototype, "distinct", { enumerable: false });
}
//examples
//console.log(items.distinctBy(t=>[t.id,t.name]))
//other example for callback(self, t) is let callback = (a,b)=> a.id===b.id && a.name === b.name;
if (!Array.prototype.distinctBy) {
    Array.prototype.distinctBy = function (callback) {
        ...
        var callbackFilter = function (value, self) {
            return callback === undefined ? self.indexOf(value) : value.findIndex(function (t) {
                //return callback(self, t);
                return JSON.stringify(callback(t)) === JSON.stringify(callback(self));
            }) < 0 ? [].concat(value, self) : value;
        };
        return this.reduce(function (x, y) {
            return callbackFilter(x, y);
        }, []);
        //this.reduce((x, y) => x.findIndex(e=>e.==y. && e.==y.)<0 ? [...x, y]: x, []);
    };
    Object.defineProperty(Array.prototype, "distinctBy", { enumerable: false });
}
...
if (!Array.prototype.orderBy) {
    Array.prototype.orderBy = function (callback, order) {
        order = typeof (order) === "string" ? order.toLowerCase() : 'asc';
    ...
    Object.defineProperty(Array.prototype, "orderBy", { enumerable: false });
}
...
if (!Array.prototype.toKeysValues) {
    Array.prototype.toKeysValues = function () {
        return this.map(function (e) {
            var ee = e;
            if (!(ee instanceof Object)) {
                ee = {};
                ee[e] = e;
            }
            return ee;
    ...
    Object.defineProperty(Array.prototype, "toKeysValues", { enumerable: false });
}

if (Array.prototype.associate !== "function") {
    Array.prototype.associate = function (values) {
        return this.reduce(function (previous, key, index) {
            previous[key] = values[index];
            return previous;
        }, {});
    };
    Object.defineProperty(Array.prototype, "associate", { enumerable: false });
}
...
if (Array.prototype.add !== "function") {
    Array.prototype.add = function (item) {
        this.push(item);
    };
    Object.defineProperty(Array.prototype, "add", { enumerable: false });
}
if (Array.prototype.insert !== "function") {
    Array.prototype.insert = function (index, item) {
        this.splice(index, 0, item);
    };
    Object.defineProperty(Array.prototype, "insert", { enumerable: false });
}
if (Array.prototype.diff !== "function") {
    Array.prototype.diff = function (items, callback) {
        callback = typeof callback === "function" ? callback : function (t) { return t; };
        return this.filter(function (t) { return items.includes(callback(t)) === false; });
    };
    Object.defineProperty(Array.prototype, "diff", { enumerable: false });
}
if (Array.prototype.intersects !== "function") {
    Array.prototype.intersects = function (items, callback) {
        callback = typeof callback === "function" ? callback : function (t) { return t; };
        if (typeof this[0] === "object") {
            var results = [];
            this.forEach(function (t) {
                results = results.concat(items.filter(function (t2) {
                    var exist = callback(t) === callback(t2);
                    if (exist === true)
                        Object.assign(t2, t);
                    return exist;
                }));
            ...
            return this.filter(function (t) { return items.includes(callback(t)) === true; });
    };
    Object.defineProperty(Array.prototype, "intersects", { enumerable: false });
}
...
if (!Array.xrange) {
    Array.xrange = function (from, to, step) {
        step = step || 1;
        ...
        var parameters = from > to ? [to, from] : [from, to];
        from = parameters[0];
        to = parameters[1];
        //create range array
        return Array.apply(null, Array(Math.round((to - from) / step))).map(function (_, index) {
            var negative = from < 0 ? Math.abs(from) : 0;
            return index < negative ? from + index * step : (index - negative + 1) * step;
        });
    };
}
if (typeof Array.prototype.flatTree !== "function") {
    Array.prototype.flatTree = function (property, initialValue, deleteChilds) {
        initialValue = initialValue || [];
        deleteChilds = true;
        return this.reduce(function (accumulator, currentValue) {
            var childs = currentValue[property];
            if (childs !== undefined && childs.length > 0) {
                accumulator = accumulator.concat(currentValue);
                accumulator = childs.flatTree(property, accumulator);
                if (deleteChilds === true)
    ...
    Object.defineProperty(Array.prototype, "flatTree", { enumerable: false });
}
...
if (typeof Array.prototype.accumulate !== "function") {
    Array.prototype.accumulate = function (callback, property) {
        property = property || 'accumuate'
        var items = [];
        var single = false;
        if (typeof callback === "function")
            this.map(callback).reduce(function (a, b) { items.push(a + b); return a + b; }, 0);
        else
            this.reduce(function (a, b) { items.push(a + b); return a + b; }, 0);
        if (typeof this[0] === "number") return items;
        this.forEach(function (t, i) { t[property] = items[i] });
        return this;
    };
    Object.defineProperty(Array.prototype, "accumulate", { enumerable: false });
}
...
if (typeof CSSStyleSheet.prototype.addRule !== 'function')
    CSSStyleSheet.prototype.addRule = function(selector, rule, index) {
        if (typeof index === 'undefined')
            index = this.cssRules.length;
        this.insertRule(selector + rule, index);
    };
if (typeof CSSStyleSheet.prototype.removeRule !== 'function')
    CSSStyleSheet.prototype.removeRule = function(index) {
        this.deleteRute(index);
    };
if (typeof CanvasRenderingContext2D.prototype.addLine !== "function") {
    CanvasRenderingContext2D.prototype.addLine = function(startPoint, endPoint) {
        this.moveTo(startPoint.x, startPoint.y);
        this.lineTo(endPoint.x, endPoint.y);
    };
}
if(typeof CanvasRenderingContext2D.prototype.fillTextMultiline !== "function"){
	CanvasRenderingContext2D.prototype.fillTextMultiline = function(text, x, y, maxWidth, lineHeight)  {
...
if (typeof Date.fromDate != "function")
...
if(!Date.fromMilliseconds){
	Date.fromMilliseconds = function (milliseconds) {
...
if (!Date.prototype.toLocalDateISOString) {
    (function () {
        function pad(number) {
            if (number < 10) {
                return '0' + number;
...
if (!Date.prototype.getUTCFullMonth) {
    (function () {
...
if (!Date.prototype.getFullMonthName) {
    (function () {
        Date.prototype.getFullMonthName = function (lang) {
            lang = lang || 'en';
            return Date.MONTH.LANG[lang][this.getMonth()];
        };
    }());
}
if (!Date.prototype.getUTCFullMonthName) {
    (function () {
        Date.prototype.getUTCFullMonthName = function (lang) {
            lang = lang || 'en';
            return Date.MONTH.LANG[lang][this.getUTCMonth()];
        };
    }());
}
if (!Date.prototype.getFullDay) {
    (function () {
...
if (!Date.prototype.getUTCFullDay) {
    (function () {
...
if (typeof Date.prototype.getFullDayName !== "function")
    Date.prototype.getFullDayName = function () {
        return Date.DAY.LANG[lang][this.getFullDay()];
    };
if (typeof Date.prototype.getUTCFullDayName !== "function")
    Date.prototype.getUTCFullDayName = function () {
        return Date.DAY.LANG[lang][this.getUTCFullDay()];
    };
if (typeof Date.prototype.getFullDayNameAbbr !== "function")
    Date.prototype.getFullDayNameAbbr = function () {
        return this.getFullDayName().slice(0, 3);
    };
if (typeof Date.prototype.getUTCFullDayNameAbbr !== "function")
    Date.prototype.getUTCFullDayNameAbbr = function () {
        return this.getUTCFullDayName().slice(0, 3);
    };
if (typeof Date.prototype.getFullMonthNameAbbr !== "function")
    Date.prototype.getFullMonthNameAbbr = function () {
        return this.getFullMonthName().slice(0, 3);
    };
if (typeof Date.prototype.getUTCFullMonthNameAbbr !== "function")
    Date.prototype.getUTCFullMonthNameAbbr = function () {
...
if (typeof Date.prototype.to24HourMinuteString != "function")
    Date.prototype.to24HourMinuteString = function() {
        var h = "0" + this.getHours();
        var m = "0" + this.getMinutes();
        var s = "0" + this.getSeconds();
        return h.slice(-2) + ":" + m.slice(-2);
    };
if (typeof Date.prototype.toLocalTimeString != "function")
    Date.prototype.toLocalTimeString = function(locale) {
		locale = locale || Date.LOCALE;
		var options = {hour:'2-digit', minute:'2-digit', second:'2-digit',timeZone: Date.TIMEZONE };
		return this.toLocaleString(locale, options);
	};
if (typeof Date.prototype.toLocalDateString != "function")
    Date.prototype.toLocalDateString = function(locale) {
		locale = locale || Date.LOCALE;
		var options = { year: 'numeric', month: '2-digit', day: '2-digit',timeZone: Date.TIMEZONE };
		return this.toLocaleString(locale, options).split('/').join('-');
	};
if (typeof Date.prototype.toLocalString != "function")
    Date.prototype.toLocalString = function(locale) {
		locale = locale || Date.LOCALE;
		var options = { year: 'numeric', month: '2-digit', day: '2-digit', hour:'2-digit', minute:'2-digit', second:'2-digit', timeZone: Date.TIMEZONE };
		return this.toLocaleString(locale, options).split('/').join('-');
	};
if (typeof Date.prototype.toLocalString2 != "function")
    Date.prototype.toLocalString2 = function(locale) {
		locale = locale || Date.LOCALE;
		var y=d.getFullYear();
		var m=d.getMonth()+1;
		var dd=d.getDate();
		var f=(locale in Date.FORMATS)?Date.FORMATS[locale]:"yyyy-MM-dd";
...
Date.MONTH.LANG = Date.MONTH.LANG || {};
Date.DAY = Date.DAY || {};
Date.DAY.LANG = Date.DAY.LANG || {};
Date.MONTH.LANG['en'] = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
Date.MONTH.LANG['es'] = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Setiembre", "Octubre", "Noviembre", "Diciembre"];
Date.DAY.LANG['en'] = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
Date.DAY.LANG['es'] = ["Domingo", "Lunes", "Martes", "Mi�rcoles", "Jueves", "Viernes"];
...
if (!Element.prototype.toSVG) {
    Element.prototype.toSVG = function(style) {
    		this.setAttribute("xmlns", "http://www.w3.org/1999/xhtml");
        return '<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><style>'+(style || '')+'</style><foreignObject width="100%" height="100%">'+this.outerHTML+'</foreignObject></svg>';
    };
}
...
if (typeof Element.prototype.dispatchEvent === 'undefined') {
    Element.prototype.dispatchEvent = function(e, callback) {
        e = 'on' + e;
        return this.fireEvent(e, callback);
    };
}
(function () {
    var addEventListener = EventTarget.prototype.addEventListener;
    if (addEventListener) {
    	EventTarget.prototype.addEventListener = function(eventNames, listener,useCapture ){
    		eventNames.split(" ").forEach(function(eventName){
          	addEventListener.call(this, eventName, listener, useCapture);
        },this);
...
(function () {
    ...
    if (nativeFetch) {
      ...
      window.fetch = function (request, options) {
        ...
        //a.href = url;
        //var url = a.href;
        if (request2.url.indexOf('file:') === 0) {
          return new Promise(function (resolve, reject) {
            ...
            xhr.onload = function (e) {
              ...
              options.status = (options.status == 0 && !!xhr.responseText) ? 200 : options.status;
            ...
            xhr.open('GET', request2.url, true);
            xhr.send();
          });
        }
        else {
          return nativeFetch.apply(this, Array.prototype.slice.apply(arguments));
        }
      };
...
if (window.HTMLDialogElement !== undefined) {
	HTMLDialogElement.prototype.close = function (origFn) {
		return function () {
			//this.style.display = 'none';
			return origFn.call(this);
		};
	}(HTMLDialogElement.prototype.close);
	HTMLDialogElement.prototype.show = function (origFn) {
		return function (returnValue) {
			//this.style.display = null;
			return origFn.call(this, returnValue);
		};
	}(HTMLDialogElement.prototype.show);
	HTMLDialogElement.prototype.showModal = function (nativeShowModal) {
		return function (options) {
			this.dataset.created = this.dataset.created || false;
			if (this.dataset.created.toString() === "true") {
				nativeShowModal.call(this);
				return;
			}
			options = options || {};
			options.onClose = typeof (options.onClose) === "function" ? options.onClose : function (obj) { };
			this.dataset.created = true;
			options = typeof (options) === "string" ? { title: options } : options;
			options.title = options.title || '&nbsp';
			options.classes = options.classes || [];
			options.classes = Array.isArray(options.classes) ? options.classes : [options.classes];
			options.forceMeasures = options.forceMeasures === true;
			this.style.minWidth = '50%';
			this.style.maxWidth = '90%';
			if (options.height)
				this.style.height = options.height;
			if (options.width)
				this.style.width = options.width;
			options.classes.forEach(function (t) {
			...
			header.innerHTML += '<span>&times;</span>';
			this.innerHTML = '';
			this.appendChild(body);
			this.insertBefore(header, this.firstChild);
			this.insertBefore(footer, this.lastChild.nextSibling);
			body.style.overflowY = 'auto';

			header.lastChild.addEventListener("click", function (e) {
				this.close();
				options.onClose(this);
			}.bind(this));
			header.lastChild.addEventListener("cancel", function (e) {
				this.close();
				options.onClose(this);
			}.bind(this));
			nativeShowModal.call(this);
			body.style.height = (this.offsetHeight - (header.offsetHeight + footer.offsetHeight)) + 'px';
		};
...
HTMLElement.prototype._addFromHTML = function (position, html) {
            ...
            HTMLElement.prototype.trigger2 = function(eventName, data){
            	var event = document.createEvent("Event");
            	event.initEvent(eventName, false, true);
            	event.isLandscape = event.currentTarget.innerHeight <= event.currentTarget.innerWidth;
            	event.dataTarget = data || {};
            	if(typeof(event.dataTarget)==="object")
            		for(var i in data){
            			event[i] = data[i];
            		}
		    ...
		    var thiss = this;
		    while (thiss.hasChildNodes()) {
			thiss.removeChild(thiss.lastChild);
	    	}
	    }
	    HTMLElement.prototype.detach = function() {
           ...
           if (typeof HTMLElement.prototype.html === 'undefined') {
		    HTMLElement.prototype.html = function(value) {
			this.innerHTML = value;
		    };
	   }
	   if (typeof HTMLElement.prototype.text === 'undefined') {
		    HTMLElement.prototype.text = function(value) {
			this.textContent = value;
		    };
	   }
	   if (typeof HTMLElement.prototype.isEmpty === 'undefined') {
	   ...
	   Object.defineProperty(HTMLElement.prototype, "visible", {
		//value:true,
		get: function() { return !!(this.offsetWidth || this.offsetHeight || this.getClientRects().length); },
		enumerable: true,
		configurable: false,
		//writable:true
	  });

if (typeof HTMLInputElement.prototype.inputDecimal !== 'function')
    HTMLInputElement.prototype.inputDecimal = function() {
    	var regex = new RegExp(/[^0-9\.]/g);// keyup,blur
    	this.addEventListener("keypress", function(e){
    		this.value = this.value.replace(regex,'');
    		if ((e.which != 46 || this.value.indexOf('.') != -1) && (e.which < 48 || e.which > 57)) {
    	        e.preventDefault();
    	    }
        }.bind(this));
    };
if (typeof HTMLInputElement.prototype.inputRule !== 'function')
        HTMLInputElement.prototype.inputRule = function(rule) {
 ...
 if (typeof HTMLInputElement.prototype.mask !== 'function')
            HTMLInputElement.prototype.mask = function(rule) {
        		this.pattern = rule;           	
            	this.dataset.pattern = rule;
            	this.addEventListener("keypress", function(e){
            		var regex = new RegExp(e.currentTarget.dataset.pattern);
                	var key = String.fromCharCode(!e.charCode ? e.which : e.charCode);
	                if (regex.test(key)) {
	                    return true;
	                }
            	...
            	/*this.addEventListener("paste", function(e){
            		var regex = new RegExp(e.currentTarget.dataset.pattern);
            		console.log(e.currentTarget.dataset.pattern)
            		var paste = (e.clipboardData || window.clipboardData).getData('text');
            		if (paste.match(/[\d+]/))
            		e.preventDefault();
	            });*/
            };
            HTMLInputElement.prototype.int32 = function(){
            	var value = this.value.trim();
                if (value === undefined || value === null || value === '' || value == ' ') return 0;
                else return Number(value);
            };            
            HTMLInputElement.prototype.string = function(){
            	var value = this.value;
                return (value === undefined) || value === null ? null : value.trim();
            };
            HTMLInputElement.prototype.decimal = function(){
            	var value = this.value;
                if (value === undefined || value === null || value === '' || value == ' ') return 0;
                else return Number(value.trim());
            };
            HTMLInputElement.prototype.double = function(){
            	var value = this.value;
                if (value === undefined || value === null || value === '' || value == ' ') return 0;
                else return Number(value.trim());
            };
            HTMLInputElement.prototype.number = function(){
            	var value = this.value;
                if (value === undefined || value === null || value === '' || value == ' ') return 0;
                else return Number(value.trim());
            };
            HTMLInputElement.prototype.rgb = function(){
            	var value = this.value;
                var rgb = [0, 0, 0];
                if (value.length === 7)
                    rgb = value.match(/[A-Za-z0-9]{2}/g).map(function (v) { return Number.parseInt(v, 16) });
                return rgb;
            };
            HTMLInputElement.prototype.rgbString = function(){
                    var value = this.value;
                    var rgb = "rgb(0,0,0)";
                    if (value.length === 7)
                        rgb = "rgb(" + value.match(/[A-Za-z0-9]{2}/g).map(function (v) { return Number.parseInt(v, 16) }).join(",") + ")";
                    return rgb;
            };

HTMLSelectElement.prototype.int32 = function(){
            	var value = this.value.trim();
                if (value === undefined || value === null || value === '' || value == ' ') return 0;
                else return Number(value);
            };
...
Object.defineProperty(Navigator.prototype, 'msi', {
    get: function() {
        var ua = window.navigator.userAgent;
        return ua.indexOf("Trident");
    }
});
...
if (typeof Number.prototype.isNumeric != "function")
    Number.prototype.isNumeric = function() {
        var value = Number.parseFloat(this);
...
if (typeof Object.prototype.toInt32 !== 'function') {
    Object.prototype.toInt32 = function () {
        if (this === undefined || this === null || this <= 0 || this === '' || this == ' ') return 0;
        else return this;
    };
    Object.defineProperty(Object.prototype, "toInt32", { enumerable: false });
}
if (typeof Object.prototype.toArray !== 'function') {
    Object.prototype.toArray = function (kv) {
        ...
        for (var i in this) {
            obj = {};
            obj[i] = this[i];
			items.push((kv===true?obj:i));//(kv===true?obj:i)
        }
        return items;
    };
...
if (!Object.prototype.count) {
    Object.prototype.count = function () {
	 ...
	 Object.defineProperty(Object.prototype, "count", { enumerable: false });
}
if (!Object.assign) {
...
if (typeof Object.prototype.assign !== 'function') {
    Object.prototype.assign = function (firstSource) {
        Object.assign(this, firstSource);
    };
    Object.defineProperty(Object.prototype, "assign", { enumerable: false, configurable: false });
}
if (typeof Object.prototype.getKey !== 'function') {
    Object.prototype.getKey = function () {
        for (var i in this)
            return i;
    };
    Object.defineProperty(Object.prototype, "getKey", { enumerable: false, configurable: false });
}
if (typeof Object.prototype.getValue !== 'function') {
    ...
    Object.defineProperty(Object.prototype, "getValue", { enumerable: false, configurable:false });
}
...
if (!Object.values) {
    Object.values = function (items) {
        return Object.keys(items).map(function (element) {
...
if (!Object.from) {
    Object.from = (function () {
        ...
        return function (items) {
            if(Array.isArray(items)===false) return items;
            return items.reduce(function (result, item, index, array) {
                var key = index;
                if (typeof item === "object") {
                    key = Object.keys(item)[0]; //first property: a, b, c
                    result[key] = item[key];
                }
                else
                    result[index] = item;
...
if (!SVGElement.prototype.toImage)
SVGElement.prototype.toImage = function(){
   		var canvas = document.createElement('canvas');
        canvas.height =  this.clientHeight;
        canvas.width = this.clientWidth;
        document.body.appendChild(canvas);
        var context = canvas.getContext('2d');
        var blob = new Blob([this.outerHTML], {type: "image/svg+xml;charset=utf-8"});
...
SVGElement.prototype.toDataURL = function(mimeType){
	var thiss = this;
		return new Promise(function(resolve, reject){
    		var canvas = document.createElement('canvas');
        canvas.height =  thiss.clientHeight;
        canvas.width = thiss.clientWidth;
        document.body.appendChild(canvas);
        var context = canvas.getContext('2d');
        var blob = new Blob([thiss.outerHTML], {type: "image/svg+xml;charset=utf-8"});
        var url = URL.createObjectURL(blob);
        // Create an image and draw the SVG onto the canvas
        var image = new Image();
...
if (!String.prototype.hexToBase64) {
...
/*if (typeof Uint8Array !== 'undefined')
	console.log('si ingresaa');
if(Uint8Array.prototype.slice !== "function")
...
Window.prototype.trigger2 = function(eventName, data){
            	var event = document.createEvent("Event");
            	event.initEvent(eventName, false, true);
            	event.isLandscape = event.currentTarget.innerHeight <= event.currentTarget.innerWidth;
            	event.dataTarget = data || {};
 ...
 Window.prototype.trigger = function(eventName, data){
            	var event = new Event(eventName);
            	event.dataTarget = data || {};
            	if(typeof(event.dataTarget)==="object")
            		for(var i in data){
...
if (!Worker.create) {
    'use strict';
    Worker.create = function(script) {
        return  new Worker(Worker.createURL(script));
    };
}
if (!Worker.create2) {
    'use strict';
    Worker.create2 = function(script) {
        return new Worker(Worker.createURL2(script));
    };
}
(function(global) {
    'use strict';
